...
public class Operate_MyDB {//自定义类
	...
	public void insert_information(String id,String name,String sex, String native1, String major)
	{
	...
	//成绩录入
	public void Cjlr(String id, String math, String chinese, String english)
	{
